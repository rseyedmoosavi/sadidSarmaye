    ...
    <b-card-body>
      ...
      >
        <template #cell(id)="data">
          <b-link :href="`/profile/stuff-confirm/`+data.item.id">{{ data.index + 1 }}</b-link>
        </template>
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {key: 'nationalCode', label: 'کدملی', sortable: true},
        {key: 'birthDate', label: 'تاریخ تولد', sortable: true},
      ],
    }
  },
  updated() {
