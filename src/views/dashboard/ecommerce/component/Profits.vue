<template>
  ...
  >
    <b-card-header>
      <b-card-title>سود ها</b-card-title>
      <b-card-title class="text-success">
        <small v-if="!loading" id="somOfDeposits" v-b-tooltip.hover.v-info :title=num2per(totalSum/10)>مجموع :
          {{ convertToCurrency(totalSum) }} ریال</small>
      </b-card-title>
    </b-card-header>
    <b-card-body>
