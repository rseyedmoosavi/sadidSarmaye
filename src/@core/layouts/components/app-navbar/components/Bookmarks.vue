...
<script>
import {
  BNavbarNav, BNavItem, BTooltip, BNavItemDropdown, BFormInput, BDropdownItem,BRow,BCol
} from 'bootstrap-vue'
...
export default {
  components: {
    BNavbarNav, BNavItem, BTooltip, BNavItemDropdown, BFormInput, VuePerfectScrollbar, BDropdownItem,FullName,Today,HomeIcon,BRow,BCol
  },
  setup() {
